...
public interface VerificationCodeDao {
    ...
    //该手机号是否可以再次发送验证码
    public int CanResendVerificationCode(@Param("cell_phone_no")String cell_phone_no,@Param("now")Date now);


    //验证码是否有效 5分钟以内有效
    public int IsVerificationCodeValid(@Param("cell_phone_no")String cell_phone_no,@Param("verification_code")String verification_code,@Param("now")Date now);

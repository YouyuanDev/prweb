...
public class AliyunSMS {
    ...
    static final String accessKeyId = "aaaaa";
    static final String accessKeySecret = "bbbbbbb";
    //前面，阿里云控制台申请
...
//    }
    ...
    public static void getResponseDetail(SendSmsResponse response) throws ClientException, InterruptedException {
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
        ...
        //发短信
        SendSmsResponse response = sendPasswordSms("13774216002","123");
